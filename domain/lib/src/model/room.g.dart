...
class _$Room extends Room {
  ...
  _$Room._({this.number, this.floor, this.address}) : super._() {
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, number.hashCode), floor.hashCode), address.hashCode));
  }
...
class RoomBuilder implements Builder<Room, RoomBuilder> {
  ...
  _$Room build() {
    ...
    try {
      _$result = _$v ??
          new _$Room._(
              number: number, floor: floor, address: _address?.build());
    } catch (_) {
